...
RUN apt-get install -y -q wget unzip vim ssh apache2 libapache2-mod-php5 php5-cli php5-mysql php5-gd php-pear php5-curl curl lynx-cur php5-xcache && rm -rf /var/lib/apt/lists/*
...
RUN wget http://files.spip.net/spip/stable/spip-2.1.zip \
	&& unzip spip-2.1.zip \
	&& cp -a spip /var/www/ \
	&& rm -fr spip-2.1.zip \
